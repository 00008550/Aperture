...
| Permission policy provider | ✅ built | `Aperture.Api/Authorization` | 22 tests, `Aperture.Api.Tests` (001-P3) |
...
| Authentication (JWT) + `GET /api/me` | ✅ built | `Aperture.Api/Authentication`, `Modules/Access/Authentication` | 22 tests, `Aperture.Api.Tests` (001-P3) |
